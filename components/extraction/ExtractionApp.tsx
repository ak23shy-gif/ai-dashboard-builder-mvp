...
export function ExtractionApp() {
  ...
  async function applyQuery() {
    const url = editableQueryUrl.trim();
    if (!url) return;
    setSubmitting(true); setError('');
    try {
